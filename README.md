...
Configuration via organization attributes is done by defining attributes directly on the organization in Keycloak. Only `EXTERNAL` authentication mode is supported at the organization level.
